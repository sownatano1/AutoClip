...
def main() -> None:
    ...
    quality_v9_10.q99.q97.q6._ORIGINAL_DOWNLOAD = cookie_aware_download
    ...
    quality_v9_10.run(url, clips, min_seconds, max_seconds, whisper_model)
